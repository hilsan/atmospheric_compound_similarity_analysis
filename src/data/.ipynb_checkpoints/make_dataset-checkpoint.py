...
def process_nabladft(input_filepath, output_filepath):
    ...
    result_smiles = subprocess.run(['/scratch/work/sandsth2/Projects/atm_datasets_manuscript/src/data/getNablaDFT_Smiles.sh', infile], stdout=subprocess.PIPE, text=True)
...
def process_all_mona(input_filepath, output_filepath):
    ...
    result_smiles = subprocess.run(['/scratch/work/sandsth2/Projects/atm_datasets_manuscript/src/data/getSMILESFromMonaMsp.sh', infile], stdout=subprocess.PIPE, text=True)
...
def process_massbankeu(input_filepath, output_filepath):
    ...
    result_smiles = subprocess.run(['/scratch/work/sandsth2/Projects/atm_datasets_manuscript/src/data/getSMILESFromMbEuMsp.sh', infile], stdout=subprocess.PIPE, text=True)
